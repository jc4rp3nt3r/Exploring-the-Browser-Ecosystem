...
var iTimer = 5000;
var Toast = Swal.mixin({ // use swal to create a notification system
...
var assert = function assert(expression, message) {
    // create an assert function to test the truth of an expression
    Toast.fire({
...
$(function () {
    ...
    $('code').on('click', function (e) {
        var sCode = $(e.target).text(); // get the code to execute
